...
if usability_score == 3:
    print('The overall Usability score is :' , usability_score , 'and it is High Usable')
    
elif usability_score == 2:
    print('The overall Usability score is :' , usability_score , 'and it is Medium Usable')
    
elif usability_score == 1:
    print('The overall Usability score is :' , usability_score , 'and it is Low Usable')

elif usability_score == 0:
    print('The overall Usability score is :' , usability_score , 'and it is Neutral Usable')
    
elif usability_score == -1:
    print('The overall Usability score is :' , usability_score , 'and it is Low Unusable')
    
elif usability_score == -2:
    print('The overall Usability score is :' , usability_score , 'and it is Medium Unusable')

elif usability_score == -3:
    print('The overall Usability score is :' , usability_score , 'and it is High Unusable')
